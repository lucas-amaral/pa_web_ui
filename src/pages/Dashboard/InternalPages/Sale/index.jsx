    ...
    <>
      <Grid container>
        ...
        <TextField
          ...
          type="hidden"
          name="propertyId"
          defaultValue={sale.propertyId ? sale.propertyId : property.id}
        />
      </Grid>
          ...
          <GridBox xs={9} loadingData={loadingData}>
            {showFinancing && (
              <MonetaryInput
                ...
                inputRef={register(
                  totalValue(value, propertyValue, vehicleValue)
                )}
          ...
          <GridBox xs={9} loadingData={loadingData}>
            {showBarterVehicle && (
              <MonetaryInput
                ...
                inputRef={register(
                  totalValue(value, financingValue, propertyValue)
                )}
          ...
          <GridBox xs={9} loadingData={loadingData}>
            {showBarterProperty && (
              <MonetaryInput
                ...
                inputRef={register(
                  totalValue(value, financingValue, vehicleValue)
                )}
