...
export default function ChatBotPA({ userName, headerTitle }) {
  ...
  const [selectedPropertyTypes, setPropertyType] = useState([
    { name: 'CASA', postName: 'HOUSE', value: false },
    { name: 'APTO', postName: 'APARTMENT', value: false },
  ]);

  const [selectedConvenience, setConvenience] = useState([
    { name: 'CHURRASQUEIRA', value: false },
    { name: 'SACADA', value: false },
    { name: 'ELEVADOR', value: false },
    { name: 'PISCINA', value: false },
  ]);

  const [selectedNeighborhood, setSelectedNeighborhood] = useState([
    { name: 'CENTRO', value: false },
    { name: 'BOI MORTO', value: false },
    { name: 'CAMOBI', value: false },
  ]);
  ...
  return (
    <ChatBot
      ...
      steps={[
          ...
          options: [
            {
              ...
              label: '1 (UM)',
              trigger: (value) =>
                updateValue(value.value, 'roomsNumber', 'bathroomsLabel'),
            },
            {
              value: 2,
              label: '2 (DOIS)',
          ...
          options: [
            {
              ...
              label: '1 (UM)',
              trigger: (value) =>
                updateValue(value.value, 'bathroomsNumber', 'garageLabel'),
            },
            {
              value: 2,
              label: '2 (DOIS)',
          ...
          options: [
            {
              ...
              label: '1 (UM)',
              trigger: (value) =>
                updateValue(value.value, 'garageNumber', 'infoMessage4'),
            },
            {
              value: 2,
              label: '2 (DOIS)',
        ...
        {
          id: 'infoMessage8',
          message: 'Qual valor seria em permuta/troca por outro(s) bem(ns)?',
